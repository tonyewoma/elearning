...
<div class="wrapper">
<div class="logo">
	<a href="index.php"><h1>erudite</h1></a>
</div>
<div class="header_right">
	<div class="cssmenu">
		<ul>
			...
			<li class="active"><a href="staff.php"><span>Staff</span></a></li>
		...
		<div class="dc-grids">
				<div class="dc-head">
					<div class="dc-head-img">
						<a href="details.php"><img src="images/dc1.jpg" title="dc-name"></a>
					</div>
				...
				<div class="dc-head">
					<div class="dc-head-img">
						<a href="details.php"><img src="images/dc2.jpg" title="dc-name"></a>
					</div>
					<div class="dc-head-info">
			...
			<div class="dc-grids">
				<div class="dc-head">
					<div class="dc-head-img">
						<a href="details.php"><img src="images/dc3.jpg" title="dc-name"></a>
					</div>
					<div class="dc-head-info">
						<h2 class="style">Perspiciatis</h2>
						<span>totam rem aperiam</span>
				...
				<div class="dc-head">
					<div class="dc-head-img">
						<a href="details.php"><img src="images/dc4.jpg" title="dc-name"></a>
					</div>
					<div class="dc-head-info">
						<h2 class="style">Voluptate</h2>
						<span>totam rem aperiam</span>
...
<div class="wrapper">
	<div class="footer">
		...
		<a href="index.php"><h2>erudite</h2></a>
		<div class="copy">
