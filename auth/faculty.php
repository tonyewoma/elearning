...
if(isset($_POST['btn-signup']))
{
	...
	$name = trim($name);
	// email exist or not
	$query = "SELECT name FROM faculty WHERE name='$name'";
	...
	if($count == 0){
		...
		if(mysql_query("INSERT INTO faculty(name,datecreated,admin_id,admin_name) VALUES('$name','$date','$admin_id','$admin_name')"))
		{
			?>
...
<div class="container-fluid">
		...
		<div class="col-sm-6">
			...
			<tr>
			<td><input type="text" name="name" placeholder="User Name" required class="form-control form-group" /></td>
			</tr>
		<?php
			...
			<tr>
			<td><button type="submit" name="btn-signup" class="btn btn-success btn-lg btn-block">Create Faculty</button></td>
			</tr>
			...
			$sql = mysql_query("SELECT * FROM faculty", $connect);
			...
			while ($result1 = mysql_fetch_array ($sql))
			{
			    ...
			    echo "<td><a href=\"delete_faculty.php?id=".$result1['id']."\">Delete</a></td>";
			    echo "</tr>";
			    echo "<tbody>";
			}
			echo "</table>";
