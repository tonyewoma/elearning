...
if(isset($_POST['btn-signup']))
{
	...
	$name = trim($name);
	// email exist or not
	$query = "SELECT name FROM groupname WHERE name='$name'";
	...
	if($count == 0){
		...
		if(mysql_query("INSERT INTO groupname(name,datecreated,admin_id,admin_name) VALUES('$name','$date','$admin_id','$admin_name')"))
		{
			?>
...
<head>
    ...
    <title>eLearning - Create Level  </title>
...
<div class="container-fluid">
		...
		<?php
			...
			$sql = mysql_query("SELECT * FROM groupname", $connect);
