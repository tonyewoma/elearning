...
<div class="container-fluid">
		...
		<?php
			...
			<tr>
			<td><button type="submit" name="btn-signup" class="btn btn-success btn-lg btn-block">Create level</button></td>
			</tr>
			...
			$sql = mysql_query("SELECT * FROM classes", $connect);
			...
			while ($result1 = mysql_fetch_array ($sql))
			{
			    ...
			    echo "<td><a href=\"deleteclass.php?id=".$result1['id']."\">Delete</a></td>";
			    echo "</tr>";
			    echo "<tbody>";
			}
			echo "</table>";
