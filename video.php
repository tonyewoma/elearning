...
<div class="container-fluid" style="margin-top: 20px;">
        ...
        <div class="col-sm-6">
           ...
           <?php
            ...
            //$sql = mysql_query("SELECT * FROM users WHERE user_id=$user_id",$connect);
            //$sql=mysql_query("SELECT * FROM club_material WHERE user_id=".$_SESSION['user']);
            /*$sql = mysql_query("SELECT * FROM videos ",$connect);

            echo "<table border=\"0\" class='table table-hover'>";
            echo "<thead>";
                echo "<tr style='background: #228B22; color: #fff;'>";
                    echo "<th>Video Title</th>";
                    echo "<th>Level</th>";
                    echo "<th>Study with Videos</th>";
                echo "</tr>";
            echo "<thead>";
            ...
            while ($result1 = mysql_fetch_array ($sql))
            {
               ...
               // echo '<td><a href="'.$result1['image'].'" target="_blank">view file</a></td>';

                //echo "<td><a href=\"".$result['image']."\" target=\"_blank\" >Click To Read Materail</a></td></tr>";
                echo "<td><a href=\"auth/".$result1['video']."\" target=\"_blank\">Watch</a></td>";
                //echo "<td><a href='../auth/uploads/".$result['image']."' title=''>Click To Read Materail</a></td>";
		  ...
		  <?php
            ...
            while ($result1 = mysql_fetch_array ($sql))
            {
                ...
                echo "<td><a href=\"auth/".$result1['video']."\" target=\"_blank\" style='color:#228B22'>Watch</a></td>";
                echo "</tr>";
